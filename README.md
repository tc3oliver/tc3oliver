...
| | |
|---|---|
| [**Reusable State Economics in Interactive LLM Inference**](https://github.com/tc3oliver/llm-inference-systems) | Built and evaluated a heterogeneous ANE prefill path, sparse prefill on top of it, incremental dense-prefix recovery and a foreground-priority scheduler, under controlled and real coding-agent workloads on one Apple silicon machine. Cold 16K time-to-first-token fell from 57.84 s to 19.24 s; the same change then exposed a prefix-cache failure mode, traced at request level across 20 restores, and a protected-prefix correctness bug. Two pull requests to oMLX, both open. [Article →](https://github.com/tc3oliver/llm-inference-systems/blob/main/publications/article.zh.md) · [Engineering →](https://github.com/tc3oliver/llm-inference-systems/blob/main/ENGINEERING.md) · [Case study →](https://meowcoder.com/work/reusable-state-economics/) · [omlx#3756 →](https://github.com/jundot/omlx/pull/3756) · [omlx#3762 →](https://github.com/jundot/omlx/pull/3762) |
